...
public class Espresso extends Coffee{
	...
	// Espresso 클래스는 이미 Coffee클래스의 method를 사용할 수 있다.
	// Espresso 클래스가 Coffee 클래스의 taste() 메소드를 상요하는 것이 적절할까요?
	// No! Espresso 클래스는 자신의 맛을 표현하기 위해서 새롭게 taste() 메소드를 만드는 것이 더 좋다
	
	// 메소드 오버라이드 (method override)
	// 슈퍼클래스의 메소드를 사용하지 않기 위해서, (커피의 taste)
	// 서브클래스가 메소드를 다시 만드는 것을 의미함
	...
	// 	1) 개발자가 자바에세 이 메소드는 오버라이드 하는 것이라고 알리는 것입니다.
