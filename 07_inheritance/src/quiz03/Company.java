...
public class Company {
	...
	public void staffInfo() {
		...
		System.out.println("SalaryMan의 급여총액 :" + getSalayManTotalpay());
	}
	
	// SalaryMan들에게 지급된 급여 총액
	public int getSalayManTotalpay() {
		// Staff[] staffList; 이므로 저장된 객체들이 SalaryMan인지 검사해봐야 합니다.
